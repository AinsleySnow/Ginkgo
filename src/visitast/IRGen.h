...
private:
    ...
    public:
        ...
        Function* ToFunction() { return std::get<0>(env_); }
        GlobalVar* ToGlobalVar() { return std::get<1>(env_); }
        ...
        Statement* StackTop() { return brkcntn_.top(); }
    ...
    static void Backpatch(const std::list<BrInstr*>&, BasicBlock*);
    static std::list<BrInstr*> Merge(std::list<BrInstr*>&, std::list<BrInstr*>&);
