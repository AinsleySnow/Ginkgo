...
public:
    AddInstr(const std::string& r, const IntType* t,
        ...
        result_(r), type_(t), lhs_(o1), rhs_(o2) {}
...
public:
    TruncInstr(const std::string& r, const IntType* t1,
        ...
        result_(r), type1_(t1), type2_(t2), value_(v) {}
